    ...
    <nav className="fixed top-0 left-0 right-0 z-[140] glass px-6 py-4 flex justify-between items-center border-b border-white/5">
      ...
      >
        ...
        <div className="flex flex-col">
          <span className="font-black text-2xl tracking-tighter hidden sm:block uppercase text-white leading-none">
            {BRAND_NAME}
          </span>
          <span className="text-[8px] font-black tracking-[0.4em] text-amber-500 hidden sm:block uppercase">Strategy Group</span>
        </div>
      </div>
      ...
      <button 
        onClick={onGetQuote}
        className="bg-gradient-to-r from-amber-600 to-yellow-800 hover:from-amber-500 hover:to-yellow-700 text-white px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-xl shadow-amber-500/10"
      >
        Enquire Now
      </button>
    </nav>
